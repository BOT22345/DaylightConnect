    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdroup-filter backdrop-blur-lg bg-opacity-0'> 
        <h1 className='text-3xl font-semibold text-center text-gray-300'>Login
          <span className='text-blue-500 p-1'>DayLightConnect</span>
        </h1>
      {/* galss effect done using glass morphism generator website */}
        <form onSubmit={handleSubmit}>
          ...
          <Link to="/signup" className='test-sm hover:underline hover:text-blue-600 mt-2 inline-block'>
